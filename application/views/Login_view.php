      ...
      <div class="col-xl-10 col-lg-12 col-md-9">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            ...
            <div class="row">
              <div style="background-image: url('assets/img/11.jpg');" class="col-lg-6 d-none d-lg-block bg-login-image"></div>
              <div class="col-lg-6">
                <div class="p-5">
                <a href="<?php echo site_url('Welcome') ?>" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                  ...
                  <form class="user">
                    ...
                    <a href="<?php echo site_url('Daftarkursus') ?>" class="btn btn-primary btn-user btn-block">
                      Login
                    </a>
                    <hr>
                  </form>
